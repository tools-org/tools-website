export const convertCelsiusToKelvin = (temperature: number) =>
    temperature + 273.15;
  ...
  export const convertRankineToKelvin = (temperature: number) =>
    temperature * (5 / 9);
  export const convertKelvinToRankine = (temperature: number) =>
    temperature * (9 / 5);
