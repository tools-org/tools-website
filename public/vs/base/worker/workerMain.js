 ...
 *-----------------------------------------------------------*/ (function () {
  ...
  (function (x) {
    ...
    class R {
      ...
      record(a, C) {
        this._events.push(
          new n(a, C, x.Utilities.getHighPerformanceTimestamp()),
        );
      }
      getEvents() {
        return this._events;
    ...
    class R {
      static validateConfigurationOptions(a) {
        ...
        if (
          ...
          Array.isArray(a.ignoreDuplicateModules) ||
            (a.ignoreDuplicateModules = []),
          a.baseUrl.length > 0 &&
            (x.Utilities.endsWith(a.baseUrl, '/') || (a.baseUrl += '/')),
          typeof a.cspNonce != 'string' && (a.cspNonce = ''),
          typeof a.preferScriptTags > 'u' && (a.preferScriptTags = !1),
          a.nodeCachedData &&
            typeof a.nodeCachedData == 'object' &&
            (typeof a.nodeCachedData.seed != 'string' &&
              (a.nodeCachedData.seed = 'seed'),
            (typeof a.nodeCachedData.writeDelay != 'number' ||
              a.nodeCachedData.writeDelay < 0) &&
    ...
    class M {
      ...
      _createIgnoreDuplicateModulesMap() {
        ...
        for (let a = 0; a < this.options.ignoreDuplicateModules.length; a++)
          this.ignoreDuplicateModulesMap[
            this.options.ignoreDuplicateModules[a]
          ] = !0;
      }
      ...
      _applyPaths(a) {
        ...
        for (let S = 0, o = this.sortedPathsRules.length; S < o; S++)
          if (
            ((C = this.sortedPathsRules[S]), x.Utilities.startsWith(a, C.from))
          ) {
            let s = [];
            for (let p = 0, e = C.to.length; p < e; p++)
              s.push(C.to[p] + a.substr(C.from.length));
            return s;
          }
        return [a];
      }
        ...
        if (!x.Utilities.endsWith(C, '.js') && !x.Utilities.isAbsolutePath(C)) {
          ...
          for (let o = 0, s = S.length; o < s; o++)
            (this.isBuild() && S[o] === 'empty:') ||
              (x.Utilities.isAbsolutePath(S[o]) ||
                (S[o] = this.options.baseUrl + S[o]),
              !x.Utilities.endsWith(S[o], '.js') &&
                !x.Utilities.containsQueryString(S[o]) &&
                (S[o] = S[o] + '.js'));
        } else
          !x.Utilities.endsWith(C, '.js') &&
            !x.Utilities.containsQueryString(C) &&
            (C = C + '.js'),
            (S = [C]);
      ...
      shouldInvokeFactory(a) {
        return !!(
          ...
          (this.options.buildForceInvokeFactory &&
            this.options.buildForceInvokeFactory[a])
        );
      }
    ...
    class a {
      ...
      _initNodeRequire(s, p) {
        ...
        g.prototype._compile = function (m, v) {
          ...
          return (
            d._handleCachedData(r, E, A, !w.cachedData, p),
            d._verifyCachedData(r, E, A, c, p),
            _
          );
        };
      }
      load(s, p, e, d) {
        ...
        if (/^node\|/.test(p)) {
          ...
          this._readSourceAndCachedData(E, w, v, (c, r, u, h) => {
            ...
            this._handleCachedData(_, f, w, A && !u, s),
              this._verifyCachedData(_, f, w, h, s);
          });
        }
      }
      ...
      _createAndWriteCachedData(s, p, e, d) {
        ...
        const E = () => {
          setTimeout(() => {
            v ||
              (v = this._crypto.createHash('md5').update(p, 'utf8').digest());
            ...
            if (!(L.length === 0 || L.length === b || m >= 5)) {
              ...
              (b = L.length),
                this._fs.writeFile(e, Buffer.concat([v, L]), (A) => {
                  A && d.getConfig().onError(A),
                    d.getRecorder().record(63, e),
                    E();
                });
            }
          }, g * Math.pow(4, m++));
    ...
    class C {
      ...
      getBuildInfo() {
        ...
        for (let p = 0, e = this._modules2.length; p < e; p++) {
          ...
          o[s++] = {
            ...
            path: g,
            defineLocation:
              g && b ? C._findRelevantLocationInStack(g, b) : null,
            dependencies: m,
            shim: null,
            exports: d.exports,
          };
      ...
      _normalizeDependencies(o, s) {
        ...
        for (let d = 0, g = o.length; d < g; d++)
          p[e++] = this._normalizeDependency(o[d], s);
        return p;
      }
          ...
          for (let p = 0, e = s.length; p < e; p++) {
            ...
            if (this._hasDependencyPath(d.id, o.id)) {
              ...
              b.reverse(),
                b.push(d.id),
                console.warn(
                  b.map((m) => this._moduleIdProvider.getStrModuleId(m))
                    .join(` => 
`),
                ),
                o.unresolvedDependenciesCount--;
            ...
            if (
              ...
              m ||
                ((m = []), this._inversePluginDependencies2.set(d.pluginId, m)),
                m.push(d),
      ...
      _onModuleComplete(o) {
        ...
        if (b) {
          ...
          for (let m = 0, v = b.length; m < v; m++)
            this._loadPluginDependency(o.exports, b[m]);
        }
      }
    }
    x.ModuleManager = C;
  ...
  (function (x) {
    ...
    const M = function (S, o, s) {
      typeof S != 'string' && ((s = o), (o = S), (S = null)),
        ...
        S
          ? R.defineModule(S, o, s, null, null)
          : R.enqueueDefineAnonymousModule(o, s);
    };
    M.amd = { jQuery: !0 };
    ...
    function C() {
      if (typeof x.global.require < 'u' || typeof require < 'u') {
        ...
        if (typeof S == 'function' && typeof S.resolve == 'function') {
          ...
          (x.global.nodeRequire = o),
            (a.nodeRequire = o),
            (a.__$__nodeRequire = o);
        }
      }
    ...
    function d(b, m) {
      ...
      return {
        ...
        getConfiguredDefaultLocale:
          (v = m.getConfiguredDefaultLocale) !== null && v !== void 0
            ? v
            : (E) => {},
      };
    }
    ...
    function g(b, m, v, E) {
      ...
      if (!b || b.length === 0)
        return v({
          ...
          getConfiguredDefaultLocale: () => {
            var h;
            return (h = A.availableLanguages) === null || h === void 0
              ? void 0
              : h['*'];
          },
        });
      ...
      const u = (h) => {
        Array.isArray(h) ? (h.localize = o(h)) : (h.localize = o(h[b])),
          (h.getConfiguredDefaultLocale = () => {
            var f;
            return (f = A.availableLanguages) === null || f === void 0
              ? void 0
              : f['*'];
          }),
          v(h);
...
//# sourceURL=${g}`),
                  (i
                    ? globalThis.eval(i.createScript('', m))
                    : new Function(m)
                  ).call(globalThis),
                  e();
              })
          ...
          S(),
            require([e], function (d) {
              setTimeout(function () {
                ...
                for (
                  globalThis.onmessage = (b) => g.onmessage(b.data, b.ports);
                  p.length > 0;
      ...
      class Q {
        ...
        findLastMaxBy(T) {
          ...
          return (
            this.iterate(
              (t) => (
                (H || y.isGreaterThan(T(t, q))) && ((H = !1), (q = t)), !0
              ),
            ),
            q
          );
    ...
    Y(X[27], J([0, 1]), function (x, n) {
      ...
      class R {
        ...
        get(a) {
          ...
          return (
            this.lastArgKey !== C &&
              ((this.lastArgKey = C), (this.lastCache = this.fn(a))),
            this.lastCache
          );
        }
      }
    ...
    Y(X[28], J([0, 1]), function (x, n) {
      ...
      class i {
        ...
        static fromRGBA(o) {
          ...
          if (L > 0) {
            switch (
              ((v = Math.min(E <= 0.5 ? L / (2 * E) : L / (2 - 2 * E), 1)), g)
            ) {
              case s:
                m = (p - e) / L + (p < e ? 6 : 0);
                break;
      ...
      class C {
        ...
        constructor(o) {
          if (o)
            if (o instanceof M) this.rgba = o;
              ...
              (this._hsva = o), (this.rgba = a.toRGBA(o));
        ...
        toString() {
          return (
            this._toString || (this._toString = C.Format.CSS.format(this)),
            this._toString
          );
        }
            ...
            (function (e) {
              ...
              function L(r, u = !1) {
                return u && r.rgba.a === 1
                  ...
                  : `#${v(r.rgba.r)}${v(r.rgba.g)}${v(r.rgba.b)}${v(
...
` +
      ...
      function S(m) {
        return m instanceof o
          ? !0
          : m instanceof Error && m.name === C && m.message === C;
      }
      ...
      class b extends Error {
        constructor(v) {
          super(v || 'An unexpected bug occurred.'),
    ...
    Y(X[30], J([0, 1]), function (x, n) {
      ...
      class R {
        ...
        define(d, g) {
          (this._keyCodeToStr[d] = g),
            (this._strToKeyCode[g.toLowerCase()] = d);
        }
        keyCodeToStr(d) {
    ...
    Y(X[11], J([0, 1, 14, 15]), function (x, n, R, M) {
      ...
      class r {
        ...
        deleteAndDispose(h) {
          var f;
          (f = this._store.get(h)) === null || f === void 0 || f.dispose(),
    ...
    Y(X[5], J([0, 1, 27, 31]), function (x, n, R, M) {
      ...
      function f(P, O, W = 0, $ = P.length, ee = 0, ae = O.length) {
        for (; W < $ && ee < ae; W++, ee++) {
          ...
          if (pe === le) continue;
          if (pe >= 128 || le >= 128)
            return u(P.toLowerCase(), O.toLowerCase(), W, $, ee, ae);
      ...
      class b {
        ...
        _step() {
          ...
          for (let l = 0; l < 64; l += 4)
            v.setUint32(l, E.getUint32(l, !1), !1);
    ...
    Y(X[17], J([0, 1, 29, 32]), function (x, n, R, M) {
      ...
      class s {
        ...
        _ComputeDiff(e, d, g, b, m) {
          ...
          return (
            m && (E = this.PrettifyChanges(E)), { quitEarly: v[0], changes: E }
          );
        }
        ComputeDiffRecursive(e, d, g, b, m) {
          for (m[0] = !1; e <= d && g <= b && this.ElementsAreEqual(e, g); )
            e++, g++;
          ...
          for (let U = 1; U <= h / 2 + 1; U++) {
            ...
            for (let T = w; T <= c; T += 2) {
              T === w || (T < c && l[T - 1] < l[T + 1])
                ...
                (A = L - (T - N) - D);
              const q = L;
              for (; L < d && A < b && this.ElementsAreEqual(L + 1, A + 1); )
                L++, A++;
              if (
                ((l[T] = L),
                L + A > V + Q && ((V = L), (Q = A)),
        ...
        ConcatenateChanges(e, d) {
          ...
          if (this.ChangesOverlap(e[e.length - 1], d[0], g)) {
            ...
            return (
              ...
              S.Copy(d, 0, b, e.length, d.length),
              b
            );
          }
        }
    ...
    Y(X[33], J([0, 1, 18]), function (x, n, R) {
      ...
      function i(C, S) {
        if ((0, R.isString)(S)) {
          const o = M[S];
          if (o === void 0)
            throw new Error(`${C} references an unknown codicon: ${S}`);
          S = o;
        }
        return (M[C] = S), { id: C };
      }
    ...
    Y(X[20], J([0, 1, 19]), function (x, n, R) {
      ...
      class M {
        ...
        get(C) {
          return C >= 0 && C < 256
            ? this._asciiMap[C]
            : this._map.get(C) || this._defaultValue;
        }
        clear() {
    ...
    Y(X[6], J([0, 1, 4]), function (x, n, R) {
      ...
      class M {
        ...
        join(a) {
          return new M(
            Math.min(this.start, a.start),
            Math.max(this.endExclusive, a.endExclusive),
          );
        }
        intersect(a) {
    ...
    Y(X[3], J([0, 1]), function (x, n) {
      ...
      class R {
        ...
        with(i = this.lineNumber, a = this.column) {
          return i === this.lineNumber && a === this.column
            ? this
            : new R(i, a);
        }
        delta(i = 0, a = 0) {
      ...
      class M {
        ...
        static plusRange(a, C) {
          ...
          return (
            C.startLineNumber < a.startLineNumber
              ...
              : C.startLineNumber === a.startLineNumber
              ? ((S = C.startLineNumber),
                (o = Math.min(C.startColumn, a.startColumn)))
              : ((S = a.startLineNumber), (o = a.startColumn)),
            C.endLineNumber > a.endLineNumber
              ? ((s = C.endLineNumber), (p = C.endColumn))
              : C.endLineNumber === a.endLineNumber
              ? ((s = C.endLineNumber),
                (p = Math.max(C.endColumn, a.endColumn)))
        ...
        static areIntersectingOrTouching(a, C) {
          return !(
            ...
            (a.endLineNumber === C.startLineNumber &&
              a.endColumn < C.startColumn) ||
            C.endLineNumber < a.startLineNumber ||
            (C.endLineNumber === a.startLineNumber &&
              C.endColumn < a.startColumn)
          );
        }
    ...
    Y(X[36], J([0, 1, 6, 7]), function (x, n, R, M) {
      ...
      function o(s, p, e, d, g) {
        ...
        for (
          ...
          e.getElement(s.seq2Range.start + v) ===
            e.getElement(s.seq2Range.endExclusive + v) &&
          v < 20;
      ...
      class a {
        compute(S, o, s = M.InfiniteTimeout.instance, p) {
          if (S.length === 0 || o.length === 0)
            return M.DiffAlgorithmResult.trivial(S, o);
          ...
          for (let w = 0; w < S.length; w++)
            for (let c = 0; c < o.length; c++) {
              if (!s.isValid())
                return M.DiffAlgorithmResult.trivialTimedOut(S, o);
    ...
    Y(X[23], J([0, 1]), function (x, n) {
      ...
      class M {
        constructor(C, S, o) {
          (this.originalRange = C),
            (this.modifiedRange = S),
            (this.innerChanges = o);
        }
        toString() {
    ...
    Y(
      X[40],
      J([0, 1, 17, 23, 5, 2, 10, 21]),
      function (x, n, R, M, i, a, C, S) {
        'use strict';
        Object.defineProperty(n, '__esModule', { value: !0 }),
            ...
            for (const y of l.changes) {
              ...
              N &&
                ...
                ((B = new M.LineRangeMapping(
                  ...
                  N.innerChanges && B.innerChanges
                    ? N.innerChanges.concat(B.innerChanges)
                    : void 0,
                )),
                _.pop()),
                _.push(B),
        ...
        class e {
          ...
          createCharSequence(c, r, u) {
            ...
            for (let N = r; N <= u; N++) {
              ...
              !c &&
                N < u &&
                ((h[_] = 10), (f[_] = N + 1), (l[_] = y.length + 1), _++);
            }
            return new d(h, f, l);
          }
        }
        ...
        function b(w) {
          ...
          for (let u = 1, h = w.length; u < h; u++) {
            ...
            Math.min(l, _) < o
              ? ((r.originalLength =
                  f.originalStart + f.originalLength - r.originalStart),
                (r.modifiedLength =
                  f.modifiedStart + f.modifiedLength - r.modifiedStart))
              : (c.push(f), (r = f));
          }
          return c;
        }
        ...
        class v {
          constructor(c, r, u) {
            (this.shouldComputeCharChanges = u.shouldComputeCharChanges),
              (this.shouldPostProcessCharChanges =
                u.shouldPostProcessCharChanges),
              ...
              (this.continueCharDiff = A(
                u.maxComputationTime === 0
                  ? 0
                  : Math.min(u.maxComputationTime, 5e3),
              ));
          }
          computeDiff() {
            if (
          ...
          _pushTrimWhitespaceCharChange(c, r, u, h, f, l, _) {
            if (this._mergeTrimWhitespaceCharChange(c, r, u, h, f, l, _))
              return;
            let N;
            this.shouldComputeCharChanges &&
              (N = [new g(r, u, r, h, f, l, f, _)]),
    ...
    Y(
      ...
      function (x, n, R, M, i, a, C, S, o, s, p, e) {
        ...
        function v(l, _, N) {
          ...
          l.modifiedRange.startColumn - 1 >=
            ...
            l.originalRange.startColumn - 1 >=
              _[l.originalRange.startLineNumber - 1].length &&
            (y = 1),
        ...
        function* E(l, _) {
          let N, y;
          for (const D of l)
            y !== void 0 && _(y, D) ? N.push(D) : (N && (yield N), (N = [D])),
              (y = D);
          N && (yield N);
        }
        class L {
        ...
        function A(l) {
          ...
          for (
            ;
            _ < l.length && (l.charCodeAt(_) === 32 || l.charCodeAt(_) === 9);
...
`.charCodeAt(0),
          ...
          translateOffset(_) {
            if (this.lineRange.isEmpty)
              return new a.Position(this.lineRange.start + 1, 1);
            let N = 0,
          ...
          findWordContaining(_) {
            if (_ < 0 || _ >= this.elements.length || !c(this.elements[_]))
              return;
            let N = _;
    ...
    Y(X[43], J([0, 1, 28]), function (x, n, R) {
      ...
      function C(d, g) {
        ...
        if (b)
          return { range: d, color: i(b.rgba.r, b.rgba.g, b.rgba.b, b.rgba.a) };
      }
      function S(d, g, b) {
      ...
      function e(d) {
        return !d ||
          typeof d.getValue != 'function' ||
          typeof d.positionAt != 'function'
          ? []
          : p(d);
      }
          ...
          for (let v = 1, E = d.getLineCount(); v <= E; v++) {
            ...
            for (; w < A; ) {
              ...
              if (u === 13) {
                ...
                let D;
                y === 91 ? ((f = !0), (D = 0)) : (D = b.get(y)),
                  D === 1 ? (N = !0) : (u = 13);
              } else (u = g.nextState(u, y)), u === 0 && (N = !0);
              N &&
                ((u = 1), (h = !1), (f = !1), (_ = !1), (c = w + 1), (r = y)),
                w++;
            }
    ...
    Y(X[47], J([0, 1, 26, 19]), function (x, n, R, M) {
      ...
      class a {
        ...
        insertValues(o, s) {
          (this._values = (0, R.arrayInsert)(this._values, o, s)),
            this._invalidate(o);
        }
        _invalidate(o) {
          (this._isValid = !1),
      ...
      class d {
          ...
          return u
            ? u.regex.multiline
              ? this._doFindMatchesMultiline(
                  L,
                  w,
                  new v(u.wordSeparators, u.regex),
                  c,
                  r,
                )
        ...
        static _getMultilineMatchRange(L, A, w, c, r, u) {
          let h,
            f = 0;
          c
            ? ((f = c.findLineFeedCountBeforeOffset(r)), (h = A + r + f))
            : (h = A + r);
          let l;
          if (c) {
...
`
          ...
          for (w.reset(0); (N = w.next(h)); )
            if (
              ((l[_++] = p(
                this._getMultilineMatchRange(L, u, h, f, N.index, N[0]),
                N,
                c,
              )),
              _ >= r)
        ...
        static _doFindMatchesLineByLine(L, A, w, c, r) {
          ...
          const f = L.getLineContent(A.startLineNumber).substring(
            A.startColumn - 1,
          );
          h = this._findMatchesInLine(
            w,
          ...
          if (h < r) {
            const l = L.getLineContent(A.endLineNumber).substring(
              0,
              A.endColumn - 1,
            );
        ...
        static _doFindNextMatchMultiline(L, A, w, c) {
          const r = new i.Position(A.lineNumber, 1),
            ...
            h = L.getLineCount(),
            f = L.getValueInRange(
              new a.Range(r.lineNumber, r.column, h, L.getLineMaxColumn(h)),
              1,
            ),
            l =
              L.getEOL() ===
...
`
        ...
        static _findFirstMatchInLine(L, A, w, c, r) {
          ...
          const u = L.next(A);
          return u
            ? p(new a.Range(w, u.index + 1, w, u.index + 1 + u[0].length), u, r)
            : null;
        }
        ...
        static _doFindPreviousMatchMultiline(L, A, w, c) {
          ...
          return A.lineNumber !== u || A.column !== L.getLineMaxColumn(u)
            ? this._doFindPreviousMatchMultiline(
                L,
                new i.Position(u, L.getLineMaxColumn(u)),
                w,
                c,
              )
            : null;
        ...
        static _findLastMatchInLine(L, A, w, c) {
          ...
          for (L.reset(0); (u = L.next(A)); )
            r = p(
              new a.Range(w, u.index + 1, w, u.index + 1 + u[0].length),
              u,
              c,
            );
          return r;
          ...
          e: for (let _ = m, N = v; _ <= N; _++) {
            ...
            do
              if (((u = w.next(y)), u)) {
                ...
                let U = (0, C.getWordAtText)(
                  k + 1,
                  C.DEFAULT_WORD_REGEXP,
                  y,
                  0,
                );
...
` ||
    ...
    Y(X[51], J([0, 1]), function (x, n) {
      ...
      (function (t) {
        (t[(t.acceptSuggestionOnCommitCharacter = 0)] =
          ...
          (t[(t.renderValidationDecorations = 93)] =
            'renderValidationDecorations'),
          (t[(t.renderWhitespace = 94)] = 'renderWhitespace'),
          (t[(t.revealHorizontalRightPadding = 95)] =
          ...
          (t[(t.suggestOnTriggerCharacters = 116)] =
          ...
          (t[(t.wordWrapBreakAfterCharacters = 127)] =
            'wordWrapBreakAfterCharacters'),
          (t[(t.wordWrapBreakBeforeCharacters = 128)] =
    ...
    Y(X[8], J([0, 1, 52]), function (x, n, R) {
      ...
      const w =
          typeof ((M = A?.versions) === null || M === void 0
            ? void 0
            : M.electron) == 'string',
        c = w && A?.type === 'renderer';
      ...
      function f() {
        if (!h) {
          ...
          (l[0] = 1),
            (l[1] = 2),
            (u = new Uint16Array(l.buffer)[0] === (2 << 8) + 1);
        }
        return u;
      }
      (n.isLittleEndian = f),
    ...
    Y(X[54], J([0, 1, 53]), function (x, n, R) {
      ...
      n.win32 = {
          ...
          for (let l = r.length - 1; l >= -1; l--) {
            ...
            if (l >= 0) {
              ...
              u.length === 0
                ...
                : ((_ = R.env[`=${u}`] || R.cwd()),
                  (_ === void 0 ||
                    (_.slice(0, 2).toLowerCase() !== u.toLowerCase() &&
                      _.charCodeAt(2) === s)) &&
                    (_ = `${u}\\`));
            const N = _.length;
            let y = 0,
            ...
            if (f) {
              ...
              ((h = `${_.slice(y)}\\${h}`), (f = k), k && u.length > 0)
            )
              break;
          }
        ...
        isAbsolute(r) {
          ...
          return (
            v(h) ||
            (u > 2 && L(h) && r.charCodeAt(1) === p && v(r.charCodeAt(2)))
          );
        },
        join(...r) {
        ...
        relative(r, u) {
          ...
          if (
            h === f ||
            ((r = h.toLowerCase()), (u = f.toLowerCase()), r === u)
          )
            return '';
          let l = 0;
          ...
          let V = '';
          for (U = l + I + 1; U <= _; ++U)
            (U === _ || r.charCodeAt(U) === s) &&
              (V += V.length === 0 ? '..' : '\\..');
          return (
            (y += I),
            V.length > 0
              ? `${V}${f.slice(y, D)}`
              : (f.charCodeAt(y) === s && ++y, f.slice(y, D))
          );
        },
        toNamespacedPath(r) {
        ...
        dirname(r) {
          ...
          if (v(l)) {
            ...
            L(l) &&
              r.charCodeAt(1) === p &&
              ((h = u > 2 && v(r.charCodeAt(2)) ? 3 : 2), (f = h));
          let _ = -1,
            N = !0;
          for (let y = u - 1; y >= f; --y)
            if (v(r.charCodeAt(y))) {
        ...
        basename(r, u) {
          ...
          if (
            ...
            return (
              h === f ? (f = y) : f === -1 && (f = r.length), r.slice(h, f)
            );
          }
          for (_ = r.length - 1; _ >= h; --_)
            if (v(r.charCodeAt(_))) {
      ...
      (n.posix = {
        ...
        relative(r, u) {
          if (
            ...
            b(u, 'to'),
            r === u ||
              ((r = n.posix.resolve(r)), (u = n.posix.resolve(u)), r === u))
          )
            return '';
          const h = 1,
            f = r.length,
          ...
          if (k === y)
            if (N > y) {
              ...
              l > y &&
                (r.charCodeAt(h + k) === o ? (D = k) : k === 0 && (D = 0));
          let B = '';
          for (k = h + D + 1; k <= f; ++k)
            (k === f || r.charCodeAt(k) === o) &&
              (B += B.length === 0 ? '..' : '/..');
    ...
    Y(X[9], J([0, 1, 4, 14, 11, 16, 24]), function (x, n, R, M, i, a, C) {
      ...
      (function (f) {
        ...
        function y(Z, z, G) {
          return V(
            (j, K = null, te) => Z((ie) => j.call(K, z(ie)), null, te),
            G,
          );
        }
        f.map = y;
      ...
      class g {
        static create() {
          var l;
          return new g(
            (l = new Error().stack) !== null && l !== void 0 ? l : '',
          );
        }
        constructor(l) {
          this.value = l;
...
`),
        ...
        fire(l) {
          ...
          if (this._listeners) {
            ...
            for (const D of this._listeners)
              this._deliveryQueue.push(this, D, l);
      ...
      class w extends A {
        constructor(l) {
          var _;
          super(l),
            (this._delay = (_ = l.delay) !== null && _ !== void 0 ? _ : 100);
        }
        fire(l) {
          this._handle ||
            (this.pause(),
    ...
    Y(X[13], J([0, 1, 54, 8]), function (x, n, R, M) {
      ...
      class g {
        ...
        static file(f) {
          let l = p;
          if (
            (M.isWindows && (f = f.replace(/\\/g, e)), f[0] === e && f[1] === e)
          ) {
        ...
        static revive(f) {
          if (f) {
            if (f instanceof g) return f;
            {
              const l = new m(f);
              return (
                (l._formatted = f.external),
                (l._fsPath = f._sep === b ? f.fsPath : null),
                l
              );
            }
          } else return f;
      ...
      function E(h, f, l) {
        ...
        for (let y = 0; y < h.length; y++) {
          ...
          if (
            ...
            N !== -1 &&
              ((_ += encodeURIComponent(h.substring(N, y))), (N = -1)),
        ...
        return (
          N !== -1 && (_ += encodeURIComponent(h.substring(N))),
          _ !== void 0 ? _ : h
        );
      }
      function L(h) {
        ...
        if (
          ...
          if (I !== -1) {
            ...
            (y = y.substr(I + 1)),
              ...
              I === -1
                ? (_ += l(U, !1, !1))
                : ((_ += l(U.substr(0, I), !1, !1)),
                  (_ += ':'),
                  (_ += l(U.substr(I + 1), !1, !0))),
              (_ += '@');
          }
          (y = y.toLowerCase()),
            (I = y.lastIndexOf(':')),
            I === -1
              ? (_ += l(y, !1, !0))
              : ((_ += l(y.substr(0, I), !1, !0)), (_ += y.substr(I)));
        }
        if (D) {
          if (
            D.length >= 3 &&
    ...
    Y(X[60], J([0, 1, 4, 9, 11, 12, 8, 5]), function (x, n, R, M, i, a, C, S) {
          ...
          const _ = new M.Emitter({
            ...
            onDidRemoveLastListener: () => {
              this._pendingEmitters.delete(l),
                this._send(new m(this._workerId, l)),
                (l = null);
            },
          });
          return _.event;
              ...
              _.detail instanceof Error &&
                ...
                this._send(
                  new d(
                    ...
                    f,
                    void 0,
                    (0, R.transformErrorForSerialization)(_),
                  ),
                );
            },
          );
      ...
      function L(u) {
        return (
          u[0] === 'o' && u[1] === 'n' && S.isUpperAsciiLetter(u.charCodeAt(2))
        );
      }
      function A(u) {
        ...
        _handleMessage(h, f) {
          ...
          try {
            return Promise.resolve(
              this._requestHandler[h].apply(this._requestHandler, f),
            );
          } catch (l) {
          ...
          return this._requestHandlerFactory
            ...
            : (f &&
                ...
                typeof f.paths < 'u' &&
                  typeof f.paths.vs < 'u' &&
                  delete f.paths.vs,
                typeof f.trustedTypesPolicy !== void 0 &&
                  delete f.trustedTypesPolicy,
                (f.catchError = !0),
    ...
    Y(X[57], J([0, 1, 33, 13, 2, 56]), function (x, n, R, M, i, a) {
      ...
      (n.LazyTokenizationSupport = A),
        (n.TokenizationRegistry = new a.TokenizationRegistry());
    }),
    Y(
      X[58],
      ...
      function (x, n, R, M, i, a, C, S, o, s, p, e, d, g, b, m) {
        ...
        class v extends C.MirrorTextModel {
          ...
          findMatches(w) {
            ...
            for (let r = 0; r < this._lines.length; r++) {
              const u = this._lines[r],
                ...
                f = u.matchAll(w);
              for (const l of f)
                (l.index || l.index === 0) && (l.index = l.index + h),
                  c.push(l);
            }
            return c;
          }
          ...
          getValueInRange(w) {
            ...
            return (
              h.push(this._lines[u].substring(0, w.endColumn - 1)), h.join(c)
            );
          }
          offsetAt(w) {
            return (
        ...
        class E {
          ...
          _getModels() {
            const w = [];
            return (
              Object.keys(this._models).forEach((c) => w.push(this._models[c])),
              w
            );
          }
          acceptNewModel(w) {
            this._models[w.url] = new v(
              M.URI.parse(w.url),
              w.lines,
              w.EOL,
              w.versionId,
          ...
          computeUnicodeHighlights(w, c, r) {
            return me(this, void 0, void 0, function* () {
              ...
              return u
                ? d.UnicodeTextModelHighlighter.computeUnicodeHighlights(
                    u,
                    c,
                    r,
                  )
          ...
          static computeDiff(w, c, r, u) {
            ...
            return {
              identical:
                _.changes.length > 0 ? !1 : this._modelsAreIdentical(w, c),
          ...
          computeMoreMinimalEdits(w, c, r) {
            return me(this, void 0, void 0, function* () {
              ...
              c = c.slice(0).sort((l, _) => {
                if (l.range && _.range)
                  return a.Range.compareRangesUsingStarts(l.range, _.range);
                const N = l.range ? 0 : 1,
                  y = _.range ? 0 : 1;
                return N - y;
              });
              for (let { range: l, text: _, eol: N } of c) {
                if ((typeof N == 'number' && (f = N), a.Range.isEmpty(l) && !_))
                  continue;
              ...
              e: for (const _ of w) {
                ...
                if (N) {
                  for (const y of N.words(f))
                    if (
                      !(y === c || !isNaN(Number(y))) &&
                      (l.add(y), l.size > E._suggestionsLimit)
                    )
                      break e;
                }
              }
